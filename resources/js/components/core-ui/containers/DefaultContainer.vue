  ...
  <div class="app">
    <AppHeader fixed>
      ...
      <b-link class="navbar-brand" to="#">
        <img class="navbar-brand-full" src="../../../../assets/admin/img/brand/logo.svg" width="89" height="25" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="../../../../assets/admin/img/brand/sygnet.svg" width="30" height="30" alt="CoreUI Logo">
      </b-link>
...
<script>
import nav from "../navigation/List";
